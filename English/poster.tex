		...
		\begin{column}{\threecolwid}
			\begin{block}{A Timeline of Firsts for Women in Statistics in Canada}
				\begin{timeline}{1945}{2020}{5cm}{5cm}{75cm}{115cm}
					...
					\entry{1956}{\color{nblue} The Female Employees Equal Pay Act made wage discrimination based on gender against the law.}
					...
					\entry{1970}{\color{nblue} The Royal Commission on the Status of Women in Canada details discrimination and barriers faced by women across Canada.}
					...
					\entry{1972}{\color{ngreen} The Canadian Journal of Statistics is created.}
					...
					\entry{1983}{\color{nblue}  Canadian Human Rights Act was amended to prohibit sexual harassment and to ban discrimination on the basis of pregnancy and family or marital status.}
					\entry{1986}{\color{nblue} The Employment Equity Act was introduced, aimed at redressing historic and systemic discrimination of target group populations.}
					...
					\entry{1987}{\textbf{Dr. Maureen Tingley} is recognized with the Pierre Robillard award for her PhD thesis: "Robust Confidence Intervals".}
					...
					\entry{1992}{\textbf{Dr. Brenda MacGibbon} becomes Chair of the Statistical Sciences Grant Selection Committee of the Natural Sciences and Engineering Research Council of Canada.}
					\entry{1992}{\textbf{Dr. Nancy Reid} is awarded the COPSS Presidents' Award by the  for outstanding contributions to the profession.}% COPSS = Committee of Presidents of Statistical Societies
					\entry{1992}{\textbf{Dr. Lise Manchester} is awarded the Canadian Journal of Statistics award the paper  "A technique for comparing graphical methods".}% ref: CJS/RCS vol. 19, 1991, pp 1-22.
					...
					\entry{2001}{\textbf{Dr. Colleen Cutler} is awarded the CRM-SSC Prize in Statistics for her outstanding contributions to the theory and methodology of dynamical systems, fractal dimensions, and nonlinear time series.}
					...
					\entry{2007}{\textbf{Dr. Agnes Herzberg} is awarded SSC Honorary Membership for exceptional contributions to the development of the discipline.} % ALT TEXT FROM THE OFFICIAL AWARD: for fundamental contributions to the design of experiments, applied statistics and data analysis; for her organization and leadership of conferences on statistics, science and public policy, and for dedicated service to the international statistical community.”
					\entry{2007}{\color{ngreen}The \textbf{Lise Manchester Award} was established, recognizing  excellence in state-of-the-art statistical work which considers problems of public interest and which is potentially useful for formation of Canadian public policy.} % official text
					...
					\entry{2009}{\color{ngreen} The National Institute for Complex Data Structures obtains funding for one final year.}
					...
					\entry{2016}{\color{nblue} The Inquiry into Missing and Murdered Indigenous Women and Girls is launched in response to calls for action from families, communities, and organizations.}

     \entry{2018}{\textbf{Dr. Sevgui Erman} founds the Data Science Accelerator at Statistics Canada.}
...
%      and the report NWAC (2010) What Their Stories Tell Us: Research findings from the Sisters in Spirit initiative. Native Womenâ?Ts Association of Canada. https://www.nwac.ca/wp-content/uploads/2015/07/2010-What-Their-Stories-Tell-Us-Research-Findings-SIS-Initiative.pdf
					...
					%\entry{2017}{\textbf{Dr. Charmaine Dean} became Vice President research of Waterloo.}
     					\entry{2020}{\textbf{Dr. Maryam Haghighi} becomes the founding Director of Data Science at the Bank of Canada.}
					\entry{2020}{\color{ngreen}The SSC establishes its Committee on Equity, Diversity and Inclusion.}			
					
					\entry{2023}{\textbf{Dr. Alison Gibbs} is the first person to win the SSC Distinguished Educator Award}
					\entry{2023}{\textbf{Dr. Tiffany Timbers} is the first person to win the Early Career Educator Award}
