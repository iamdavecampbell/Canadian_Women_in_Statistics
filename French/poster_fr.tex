...
\begin{frame}[t]
	\begin{columns}[t]							% the [t] option aligns the column's content at the top
		...
		\begin{column}{\threecolwid}
			\begin{block}{Chronologie des premières femmes dans le domaine de la statistique au Canada}
				\begin{timeline}{1945}{2020}{5cm}{5cm}{75cm}{115cm}
					...
					\entry{1955}{\color{ngreen} Création de la section montréalaise de l'American Statistical Association.} %<-- looks strange but this is consistent with the way SSC Liaison handles the translation %Formation of the Montreal Chapter of the American Statistical Association.}% see https://www.jstor.org/stable/2684141
					\entry{1956}{\color{nblue} La Loi sur l'égalité de salaire pour les femmes a rendu illégale la discrimination salariale fondée sur le sexe.}%The female pay act made wage discrimination based on gender against the law.}
					...
					\entry{1970}{\color{nblue} La Commission royale d'enquête sur la situation de la femme au Canada détaille les discriminations et les obstacles auxquels sont confrontées les femmes dans tout le pays.}%Royal Commission on the Status of Women detailing discrimination and barriers faced by women across Canada.}
					...
					\entry{1978}{\color{nblue}Le code canadien du travail a été modifié afin d'éliminer la grossesse comme motif de mise à pied ou de licenciement.}%The Canada Labour Code was amended to eliminate pregnancy as a basis for lay-off or dismissal.}
					...
					\entry{1986}{\color{nblue} La Loi sur l’équité en matière d’emploi a été introduite afin de remédier à la discrimination historique et systémique dont sont victimes les groupes cibles.}%The federal Employment Equity Act was introduced, aimed at redressing historic and systemic discrimination of target group populations.}
					\entry{1986}{\textbf{Nicole P.-Gendreau} devient le premier rédacteur en chef du bulletin SSC Liaison}%Gendreau} becomes inaugural editor of the SSC Liaison newsletter.} %  Nicole Gendreau, Directrice générale, Bureau de la statistique du Québec was also public relations officer: https://ssc.ca/sites/default/files/liaison/liaison-1-1.pdf
					\entry{1986}{\textbf{Dr. Priscilla E. (Cindy) Greenwood} reçoit une subvention de 500 000\$ de l'Institut d'études avancées Peter Wall.}%Greenwood} receives a grant of \$500,000 from the Peter Wall Institute of Advanced Studies.}
					\entry{1987}{\textbf{Dr. Maureen Tingley} reçoit le prix Pierre Robillard pour sa thèse de doctorat: <<Robust Confidence Intervals>>.}%Tingley} is recognized with the Pierre Robillard award for her PhD thesis.}
					\entry{1989}{\textbf{Dr. Judy-Anne Chapman} est à l'origine de la création de la Groupe de biostatistique, la première groupe de la SSC.}%Chapman} spearheads and leads the formation of the Biostatistics Section, the first Section of the SSC}% see also: https://ssc.ca/en/about/sections-regions/biostatistics/history
					...
					\entry{1992}{\textbf{Dr. Brenda MacGibbon} devient président du comité de sélection des subventions en sciences statistiques du Conseil de recherches en sciences naturelles et en génie du Canada.}%MacGibbon} becomes Chair of the NSERC Statistical Sciences Grant Selection Committee.}
					\entry{1992}{\textbf{Dr. Nancy  Reid} reçoit le Prix des présidents COPSS pour ses contributions exceptionnelles à la profession.}%Reid} is awarded the COPSS Presidents' Award by the Committee of Presidents of Statistical Societies for outstanding contributions to the profession.}%
					\entry{1992}{\textbf{Dr. Lise Manchester} reçoit le prix de La Revue canadienne de statistique pour son article "A technique for comparing graphical methods" .}%Manchester} is awarded the Canadian Journal of Statistics award for best paper for  "A technique for comparing graphical methods".}% ref: CJS/RCS vol. 19, 1991, pp 1-22.
					...
					\entry{2001}{\textbf{Dr. Colleen Cutler} reçoit le prix CRM-SSC en statistique pour ses contributions exceptionnelles à la théorie et à la méthodologie des systèmes dynamiques, des dimensions fractales et des séries chronologiques non linéaires.} %official text
					\entry{2001}{\textbf{Dr. Charmaine Dean} devient le directeur fondateur du Département de statistique et de science actuarielle de l’Université Simon-Fraser.}%Dean} becomes the Founding Chair of the Department of Statistics and Actuarial Science at Simon Fraser University.}
					\entry{2002}{\textbf{Dr. Jane F. Gentleman} reçoit le prix Janet L. Norwood pour avancement par une femme en sciences statistiques.}%Gentleman} receives Janet L. Norwood Award for Outstanding Achievement by a Woman in the Statistical Sciences.}
					...
					\entry{2007}{\textbf{Dr. Agnes Herzberg} reçoit le titre de membre honoraire de la SSC pour ses contributions exceptionnelles au développement de la discipline.}%Herzberg} is awarded SSC Honorary Membership for exceptional contributions to the development of the discipline.}.  ALT TEXT FROM THE OFFICIAL AWARD: "pour des contributions fondamentales à la planification d'expériences, la statistique appliquée et l'analyse de données; pour l'organisation et sa direction de conférences sur la statistique, la science et l'intérêt public, ainsi que pour les services dévoués rendus à la communauté statistique internationale »"
					\entry{2007}{\color{ngreen}Le prix \textbf{Lise Manchester Award} a été créé pour reconnaîttre l’excellence des travaux statistiques de pointe  pour dégager de nouvelles perspectives sur une problématique d’intérêt général pour la société et qui sont susceptibles d’orienter l’élaboration de politiques publiques dans un contexte canadien.} % official text
     ...
     \entry{2018}{\textbf{Dr. Sevgui Erman} fonde l'accélérateur de science des données à Statistique Canada.}%founds the Data Science Accelerator at Statistics Canada.}
					...
					\entry{2023}{\textbf{Dr. Alison Gibbs} reçoit le prix inaugural d’excellence en enseignement pour professeur(e) ou chercheur(e)}%is the first person to win the SSC Distinguished Educator Award}
					\entry{2023}{\textbf{Dr. Tiffany Timbers} reçoit le prix inaugural d’enseignement pour professeur(e) ou chercheur(e) en début de carrière}%is the first person to win the Early Career Educator Award}
					\entry{2025}{\textbf{B\eatrice Baribeay} becomes the first female Director General of the Modern Statistical Methods and Data Science Branch}%The appointment of Béatrice Baribeau as Director General, Modern Statistical Methods and Data Science Branch, effective November 6, 2025. Within this position, Béatrice will also hold the roles of Principal Confidentiality Officer and Principal Data Ethics, Quality and Scientific Integrity Officer.
