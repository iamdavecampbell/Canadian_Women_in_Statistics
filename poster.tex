...
%-----------------------------------------------------------
\geometry{papersize={122cm,131cm}}                  % resize the poster NOTE: find a better way
\begin{document}
\begin{frame}[t]
	\begin{columns}[t]							% the [t] option aligns the column's content at the top
		...
		\begin{column}{\threecolwid}
			\begin{block}{A Timeline of Firsts for Women in Statistics in Canada}
				\begin{timeline}{1944}{2017}{5cm}{5cm}{75cm}{106cm}
					\small  
					...
					\entry{1969}{\textbf{Isobel Loutit} becomes Chair of the Montreal Section of the American Society for Quality Control (ASQC)} % also probably Canada's first professional statistician https://ssc.ca/en/profile/isobel-loutit-statistician-quality
