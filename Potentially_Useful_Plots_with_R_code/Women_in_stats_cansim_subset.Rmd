...
=======
  mutate(sexe = case_match(Gender,
                                   "Non-binary person and Unknown gender" ~ "Personne non-binaire et \n genre inconnu",
<<<<<<< Updated upstream
>>>>>>> Stashed changes
=======
>>>>>>> Stashed changes
...
=======
  mutate(sexe = case_match(Gender,
                         "Non-binary person and\n Unknown gender" ~ "Personne non-binaire et\n genre inconnu",
<<<<<<< Updated upstream
>>>>>>> Stashed changes
=======
>>>>>>> Stashed changes
...
for (prog_group in c('Doctoral', 'Masters', 'Undergraduate')){
  ...
  dplyr::filter(Field.of.study %in% c(
     ...
     mutate(Gender = case_match(Gender,
                             ...
                             "Total, gender" ~ "Total gender"))|>
    dplyr::filter(Gender != "Total gender")|>
    bind_rows(data.frame( Date=as.Date("2012-07-01"),VALUE= NA, Gender = "Non-binary person and\n Unknown gender"))|>
      mutate(Gender = factor(Gender,
                       levels = c(
                         "Woman",
                         "Man",
